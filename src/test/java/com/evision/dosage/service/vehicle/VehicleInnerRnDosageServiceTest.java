...
import com.evision.dosage.service.vehicle.imp.VehicleInnerRnDosageServiceImpl;
...
public class VehicleInnerRnDosageServiceTest {
    @Resource
    VehicleInnerRnDosageServiceImpl service;
    ...
    private void processFile(File file) throws Exception {
        ...
        List<VehicleInnerRnDosageEntity> ret = service.processExcel(sheet);
    ...
    public void testGetDataList() throws Exception {
        List<VehicleInnerRnDosageEntity> ret = service.getDataList("", "", 1, 0);
        Assert.assertTrue(ret.size() > 0);
    }
}
